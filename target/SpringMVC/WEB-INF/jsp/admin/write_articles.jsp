                ...
                <div style="width:350px">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-body layui-text">
                            <img src="<%=request.getContextPath()%>/static/bgpic/default.jpg" alt="" width="300" height="200" id="prevView">
                            <input type="file" name="articleImage" id="" value="default.jpg"
                                   onchange="prev(this)" />
...
<script>
    $("#issue").on("click", function () {
        ...
        if (title && content) {
            ...
            $.ajax({
                type: "POST",
                url: '<%=request.getContextPath()%>/admin/article/write/new',
