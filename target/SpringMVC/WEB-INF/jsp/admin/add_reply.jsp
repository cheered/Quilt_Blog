...
<div class="layui-form" lay-filter="layuiadmin-form-useradmin" id="layuiadmin-form-useradmin"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" id="tagName" value="${comment.commentName}" disabled="disabled" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
                <textarea style="width: 245px; height: 100px;" lay-verify="phone" placeholder="请输入回复内容"
                          id="replyContent" autocomplete="off" class="layui-input"></textarea>
        </div>
    </div>
...
<script>
    var callbackdata = function () {
        var data = {
            commentPid: ${comment.id},
            commentName: '${user.userNickname}',
